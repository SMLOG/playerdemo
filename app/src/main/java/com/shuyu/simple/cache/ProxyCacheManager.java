    ...
    public void clearCache(Context context, File cachePath, String url) {
        if (TextUtils.isEmpty(url)) {
            if (cachePath == null) {
                ...
                com.shuyu.simple.utils.FileUtils.deleteFiles(new File(path));
            } else {
            ...
            if (cachePath != null) {
                ...
                com.shuyu.simple.utils.CommonUtil.deleteFile(tmpPath);
                com.shuyu.simple.utils.CommonUtil.deleteFile(path);
            } else {
                ...
                String path = StorageUtils.getIndividualCacheDirectory
                    (context.getApplicationContext()).getAbsolutePath()
                    + File.separator + name;
                com.shuyu.simple.utils.CommonUtil.deleteFile(pathTmp);
