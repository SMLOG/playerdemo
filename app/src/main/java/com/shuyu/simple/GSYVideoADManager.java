...
public class GSYVideoADManager extends GSYVideoBaseManager {
    ...
    public static final int SMALL_ID = com.shuyu.gsyvideoplayer.R.id.ad_small_id;

    public static final int FULLSCREEN_ID = com.shuyu.gsyvideoplayer.R.id.ad_full_id;
    ...
    public static boolean backFromWindowFull(Context context) {
        ...
        ViewGroup vp = (ViewGroup) (com.shuyu.simple.utils.CommonUtil.scanForActivity(context)).findViewById(Window.ID_ANDROID_CONTENT);
        View oldF = vp.findViewById(FULLSCREEN_ID);
        if (oldF != null) {
            backFrom = true;
            com.shuyu.simple.utils.CommonUtil.hideNavKey(context);
    ...
    public static boolean isFullState(Activity activity) {
        ViewGroup vp = (ViewGroup) (com.shuyu.simple.utils.CommonUtil.scanForActivity(activity)).findViewById(Window.ID_ANDROID_CONTENT);
