package com.shuyu.simple.builder;

import android.graphics.drawable.Drawable;
import android.view.View;

import com.shuyu.simple.video.StandardGSYVideoPlayer;
import com.shuyu.simple.listener.GSYStateUiListener;
...
public class GSYVideoOptionBuilder {
    ...
    //视频状体回调
    protected com.shuyu.simple.listener.VideoAllCallBack mVideoAllCallBack;

    //点击锁屏的回调
    protected com.shuyu.simple.listener.LockClickListener mLockClickListener;
    ...
    ///状态监听
    protected com.shuyu.simple.listener.GSYStateUiListener mGSYStateUiListener;

    //滤镜
    protected com.shuyu.simple.render.view.GSYVideoGLView.ShaderInterface mEffectFilter = new NoEffect();

    //进度回调
    protected com.shuyu.simple.listener.GSYVideoProgressListener mGSYVideoProgressListener;
    ...
    public void build(StandardGSYVideoPlayer gsyVideoPlayer) {
        ...
        build((com.shuyu.simple.video.base.GSYBaseVideoPlayer) gsyVideoPlayer);
    }
