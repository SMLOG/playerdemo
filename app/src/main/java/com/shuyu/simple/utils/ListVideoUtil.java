...
public class ListVideoUtil {
    ...
    private com.shuyu.simple.video.StandardGSYVideoPlayer gsyVideoPlayer;
    ...
    private com.shuyu.simple.listener.VideoAllCallBack videoAllCallBack;
    private String url;
    ...
    public ListVideoUtil(Context context) {
        gsyVideoPlayer = new com.shuyu.simple.video.StandardGSYVideoPlayer(context);
