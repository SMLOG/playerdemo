package com.shuyu.simple.utils;
...
import com.shuyu.simple.builder.GSYVideoOptionBuilder;
import com.shuyu.simple.listener.GSYVideoProgressListener;
import com.shuyu.simple.listener.LockClickListener;
...
import com.shuyu.simple.video.base.GSYBaseVideoPlayer;
import com.shuyu.simple.video.base.GSYVideoPlayer;
...
public class GSYVideoHelper {
     ...
     * 播放器
     */
    private com.shuyu.simple.video.StandardGSYVideoPlayer mGsyVideoPlayer;
    /**
     * 全屏承载布局
     */
    ...
    public GSYVideoHelper(Context context) {
        this(context, new com.shuyu.simple.video.StandardGSYVideoPlayer(context));
    }

    public GSYVideoHelper(Context context, com.shuyu.simple.video.StandardGSYVideoPlayer player) {
     ...
     * 动画回到正常效果
     */
    private void resolveMaterialToNormal(final com.shuyu.simple.video.base.GSYVideoPlayer gsyVideoPlayer) {
    ...
    private void saveLocationStatus(Context context, boolean statusBar, boolean actionBar) {
        ...
        int actionBerH = CommonUtil.getActionBarHeight(CommonUtil.getActivityNestWrapper(context));
        if (statusBar) {
    ...
    public com.shuyu.simple.builder.GSYVideoOptionBuilder getGsyVideoOptionBuilder() {
