...
import com.shuyu.simple.listener.GSYVideoGifSaveListener;
...
public class GifCreateHelper {
    ...
    private com.shuyu.simple.video.StandardGSYVideoPlayer mPlayer;
    ...
    private com.shuyu.simple.listener.GSYVideoGifSaveListener mGSYVideoGifSaveListener;
    ...
    public GifCreateHelper(com.shuyu.simple.video.StandardGSYVideoPlayer standardGSYVideoPlayer, com.shuyu.simple.listener.GSYVideoGifSaveListener gsyVideoGifSaveListener) {
     ...
     */
    public GifCreateHelper(StandardGSYVideoPlayer standardGSYVideoPlayer, com.shuyu.simple.listener.GSYVideoGifSaveListener gsyVideoGifSaveListener,
    ...
    public void createGif(File file, List<String> pics, int delay, int inSampleSize, int scaleSize,
        ...
        com.shuyu.simple.utils.AnimatedGifEncoder localAnimatedGifEncoder = new AnimatedGifEncoder();
