...
public final class MeasureHelper {
    ...
    private int mCurrentAspectRatio = com.shuyu.simple.utils.GSYVideoType.SCREEN_TYPE_DEFAULT;
    ...
    public void doMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mCurrentAspectRatio = com.shuyu.simple.utils.GSYVideoType.getShowType();
        ...
        if (mCurrentAspectRatio == com.shuyu.simple.utils.GSYVideoType.SCREEN_MATCH_FULL) {
            ...
            if (widthSpecMode == View.MeasureSpec.AT_MOST && heightSpecMode == View.MeasureSpec.AT_MOST) {
                ...
                switch (mCurrentAspectRatio) {
                    case com.shuyu.simple.utils.GSYVideoType.SCREEN_TYPE_16_9:
                        displayAspectRatio = 16.0f / 9.0f;
                        if (mVideoRotationDegree == 90 || mVideoRotationDegree == 270)
                            displayAspectRatio = 1.0f / displayAspectRatio;
                        break;
                    case com.shuyu.simple.utils.GSYVideoType.SCREEN_TYPE_18_9:
                        displayAspectRatio = 18.0f / 9.0f;
                        if (mVideoRotationDegree == 90 || mVideoRotationDegree == 270)
                            displayAspectRatio = 1.0f / displayAspectRatio;
                        break;
                    case com.shuyu.simple.utils.GSYVideoType.SCREEN_TYPE_4_3:
                        displayAspectRatio = 4.0f / 3.0f;
                        if (mVideoRotationDegree == 90 || mVideoRotationDegree == 270)
                            displayAspectRatio = 1.0f / displayAspectRatio;
                        break;
                    case com.shuyu.simple.utils.GSYVideoType.SCREEN_TYPE_CUSTOM:
                        displayAspectRatio = com.shuyu.simple.utils.GSYVideoType.getScreenScaleRatio();
                        if (mVideoRotationDegree == 90 || mVideoRotationDegree == 270)
                            displayAspectRatio = 1.0f / displayAspectRatio;
                        break;
                    case com.shuyu.simple.utils.GSYVideoType.SCREEN_TYPE_DEFAULT:
                    case com.shuyu.simple.utils.GSYVideoType.SCREEN_TYPE_FULL:
