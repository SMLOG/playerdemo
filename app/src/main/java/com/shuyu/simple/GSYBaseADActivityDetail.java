...
import com.shuyu.simple.listener.GSYSampleCallBack;
import com.shuyu.simple.utils.OrientationOption;
import com.shuyu.simple.utils.OrientationUtils;
import com.shuyu.simple.video.GSYADVideoPlayer;
...
public abstract class GSYBaseADActivityDetail<T extends GSYBaseVideoPlayer, R extends GSYADVideoPlayer> extends GSYBaseActivityDetail<T> {
    ...
    protected com.shuyu.simple.utils.OrientationUtils mADOrientationUtils;
    ...
    public void onEnterFullscreen(String url, Object... objects) {
        ...
        //隐藏调全屏对象的返回按键
        com.shuyu.simple.video.base.GSYVideoPlayer gsyVideoPlayer = (GSYVideoPlayer) objects[1];
    ...
    protected boolean isADStarted() {
        return getGSYADVideoPlayer().getCurrentPlayer().getCurrentState() >= 0 &&
                getGSYADVideoPlayer().getCurrentPlayer().getCurrentState() != com.shuyu.simple.video.base.GSYVideoView.CURRENT_STATE_NORMAL
