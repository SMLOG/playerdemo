package com.shuyu.simple.render.glrender;
...
public abstract class GSYVideoGLViewBaseRender implements GLSurfaceView.Renderer, SurfaceTexture.OnFrameAvailableListener {
    ...
    protected com.shuyu.simple.render.view.listener.GLSurfaceListener mGSYSurfaceListener;
    ...
    protected com.shuyu.simple.render.view.listener.GSYVideoGLRenderErrorListener mGSYVideoGLRenderErrorListener;
