package com.shuyu.simple.render.view;
...
import com.shuyu.simple.listener.GSYVideoShotSaveListener;
import com.shuyu.simple.render.GSYRenderView;
...
import com.shuyu.simple.utils.MeasureHelper;
import com.shuyu.simple.render.effect.NoEffect;
import com.shuyu.simple.render.glrender.GSYVideoGLViewBaseRender;
import com.shuyu.simple.render.glrender.GSYVideoGLViewSimpleRender;
import com.shuyu.simple.render.view.listener.GLSurfaceListener;
import com.shuyu.simple.render.view.listener.GSYVideoGLRenderErrorListener;
import com.shuyu.simple.render.view.listener.IGSYSurfaceListener;
...
public class GSYVideoGLView extends GLSurfaceView implements com.shuyu.simple.render.view.listener.GLSurfaceListener, IGSYRenderView, MeasureHelper.MeasureFormVideoParamsListener {
    ...
    private com.shuyu.simple.render.glrender.GSYVideoGLViewBaseRender mRenderer;
    ...
    private com.shuyu.simple.render.view.listener.GLSurfaceListener mOnGSYSurfaceListener;

    private com.shuyu.simple.render.view.listener.IGSYSurfaceListener mIGSYSurfaceListener;
    ...
    @Override
    public com.shuyu.simple.render.view.listener.IGSYSurfaceListener getIGSYSurfaceListener() {
        return mIGSYSurfaceListener;
    }

    @Override
    public void setIGSYSurfaceListener(com.shuyu.simple.render.view.listener.IGSYSurfaceListener surfaceListener) {
    ...
    @Override
    public void setGLRenderer(com.shuyu.simple.render.glrender.GSYVideoGLViewBaseRender renderer) {
    ...
    public void setGSYVideoGLRenderErrorListener(com.shuyu.simple.render.view.listener.GSYVideoGLRenderErrorListener videoGLRenderErrorListener) {
     ...
     * @param CustomRender
     */
    public void setCustomRenderer(com.shuyu.simple.render.glrender.GSYVideoGLViewBaseRender CustomRender) {
    ...
    public com.shuyu.simple.render.glrender.GSYVideoGLViewBaseRender getRenderer() {
        return mRenderer;
    }
    ...
    public static GSYVideoGLView addGLView(final Context context, final ViewGroup textureViewContainer, final int rotate,
                                           ...
                                           final com.shuyu.simple.render.glrender.GSYVideoGLViewBaseRender customRender, final int renderMode) {
