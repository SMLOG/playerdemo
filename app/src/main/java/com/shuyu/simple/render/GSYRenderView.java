package com.shuyu.simple.render;
...
import com.shuyu.simple.render.view.GSYSurfaceView;
import com.shuyu.simple.render.view.GSYTextureView;
import com.shuyu.simple.render.view.GSYVideoGLView;
import com.shuyu.simple.render.view.IGSYRenderView;
...
public class GSYRenderView {
    ...
    public void addView(final Context context, final ViewGroup textureViewContainer, final int rotate,
                        ...
                        final com.shuyu.simple.render.view.GSYVideoGLView.ShaderInterface effect, final float[] transform,
                        final com.shuyu.simple.render.glrender.GSYVideoGLViewBaseRender customRender, int mode) {
        if (GSYVideoType.getRenderType() == GSYVideoType.SUFRACE) {
            ...
            mShowView = com.shuyu.simple.render.view.GSYVideoGLView.addGLView(context, textureViewContainer, rotate, gsySurfaceListener, videoParamsListener, effect, transform, customRender, mode);
        } else {
     ...
     * 获取截图
     */
    public void taskShotPic(com.shuyu.simple.listener.GSYVideoShotListener gsyVideoShotListener) {
     ...
     * 保存截图
     */
    public void saveFrame(final File file, com.shuyu.simple.listener.GSYVideoShotSaveListener gsyVideoShotSaveListener) {
