package com.shuyu.simple.video;
...
public class StandardGSYVideoPlayer extends GSYVideoPlayer {
    ...
    @Override
    protected void cloneParams(com.shuyu.simple.video.base.GSYBaseVideoPlayer from, com.shuyu.simple.video.base.GSYBaseVideoPlayer to) {
     ...
     */
    @Override
    public com.shuyu.simple.video.base.GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
    ...
    protected void onClickUiToggle(MotionEvent e) {
        ...
        if (mIfCurrentIsFullscreen && !mSurfaceErrorPlay && mCurrentState == GSYVideoView.CURRENT_STATE_ERROR) {
        ...
        } else if (mCurrentState == GSYVideoView.CURRENT_STATE_PREPAREING) {
            if (mBottomContainer != null) {
                if (mBottomContainer.getVisibility() == View.VISIBLE) {
