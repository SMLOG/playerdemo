...
import com.shuyu.simple.utils.OrientationOption;
import com.shuyu.simple.utils.OrientationUtils;
import com.shuyu.simple.view.SmallVideoTouch;

import java.lang.reflect.Constructor;

import static com.shuyu.simple.utils.CommonUtil.getActionBarHeight;
import static com.shuyu.simple.utils.CommonUtil.getStatusBarHeight;
import static com.shuyu.simple.utils.CommonUtil.hideNavKey;
import static com.shuyu.simple.utils.CommonUtil.hideSupportActionBar;
import static com.shuyu.simple.utils.CommonUtil.showNavKey;
import static com.shuyu.simple.utils.CommonUtil.showSupportActionBar;
...
public abstract class GSYBaseVideoPlayer extends GSYVideoControlView {
    ...
    public void onInfo(int what, int extra) {
        ...
        if (what == getIPlayer().getRotateInfoFlag()) {
            checkAutoFullSizeWhenFull();
        }
    }
    ...
    private void pauseFullCoverLogic() {
        if (mCurrentState == com.shuyu.simple.video.base.GSYVideoPlayer.CURRENT_STATE_PAUSE && mTextureView != null
    ...
    private void pauseFullBackCoverLogic(GSYBaseVideoPlayer gsyVideoPlayer) {
        //如果是暂停状态
        if (gsyVideoPlayer.mCurrentState == com.shuyu.simple.video.base.GSYVideoPlayer.CURRENT_STATE_PAUSE
     ...
     * 恢复
     */
    protected void resolveNormalVideoShow(View oldF, ViewGroup vp, com.shuyu.simple.video.base.GSYVideoPlayer gsyVideoPlayer) {

        if (oldF != null && oldF.getParent() != null) {
            ViewGroup viewGroup = (ViewGroup) oldF.getParent();
            vp.removeView(viewGroup);
        }
        mCurrentState = getIPlayer().getLastState();
    ...
    protected void clearFullscreenLayout() {
        ...
        if (oldF != null) {
            ...
            com.shuyu.simple.video.base.GSYVideoPlayer gsyVideoPlayer = (com.shuyu.simple.video.base.GSYVideoPlayer) oldF;
    ...
    protected void backToNormal() {
        ...
        final View oldF = vp.findViewById(getFullId());
        final com.shuyu.simple.video.base.GSYVideoPlayer gsyVideoPlayer;
        if (oldF != null) {
            gsyVideoPlayer = (com.shuyu.simple.video.base.GSYVideoPlayer) oldF;
            //如果暂停了
    ...
    protected Runnable mCheckoutTask = new Runnable() {
        @Override
        public void run() {
            com.shuyu.simple.video.base.GSYVideoPlayer gsyVideoPlayer = getFullWindowPlayer();
            if (gsyVideoPlayer != null
    ...
    public void hideSmallVideo() {
        final ViewGroup vp = getViewGroup();
        com.shuyu.simple.video.base.GSYVideoPlayer gsyVideoPlayer = (com.shuyu.simple.video.base.GSYVideoPlayer) vp.findViewById(getSmallId());
        removeVideo(vp, getSmallId());
        mCurrentState = getIPlayer().getLastState();
        if (gsyVideoPlayer != null) {
            cloneParams(gsyVideoPlayer, this);
     ...
     */
    @SuppressWarnings("ResourceType")
    public com.shuyu.simple.video.base.GSYVideoPlayer getFullWindowPlayer() {
        ...
        com.shuyu.simple.video.base.GSYVideoPlayer gsyVideoPlayer = null;
        if (full != null) {
            gsyVideoPlayer = (com.shuyu.simple.video.base.GSYVideoPlayer) full;
        }
        return gsyVideoPlayer;
    }
     ...
     */
    @SuppressWarnings("ResourceType")
    public com.shuyu.simple.video.base.GSYVideoPlayer getSmallWindowPlayer() {
