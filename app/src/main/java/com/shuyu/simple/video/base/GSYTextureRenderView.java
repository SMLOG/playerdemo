...
public abstract class GSYTextureRenderView extends FrameLayout implements IGSYSurfaceListener, MeasureHelper.MeasureFormVideoParamsListener {
    ...
    //GL的自定义渲染
    protected com.shuyu.simple.render.glrender.GSYVideoGLViewBaseRender mRenderer;
    ...
    //GL的布局模式
    protected int mMode = com.shuyu.simple.render.view.GSYVideoGLView.MODE_LAYOUT_SIZE;
    ...
    public com.shuyu.simple.render.view.GSYVideoGLView.ShaderInterface getEffectFilter() {
