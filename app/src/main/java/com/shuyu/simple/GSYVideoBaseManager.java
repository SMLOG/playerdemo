...
import com.shuyu.simple.player.PlayerFactory;
import com.shuyu.simple.utils.Debuger;
import com.shuyu.simple.video.base.GSYVideoViewBridge;
...
public abstract class GSYVideoBaseManager implements IMediaPlayer.OnPreparedListener, IMediaPlayer.OnCompletionListener,
    ...
    protected WeakReference<com.shuyu.simple.listener.GSYMediaPlayerListener> listener;

    protected WeakReference<com.shuyu.simple.listener.GSYMediaPlayerListener> lastListener;
    ...
    @Override
    public com.shuyu.simple.listener.GSYMediaPlayerListener listener() {
        if (listener == null)
            return null;
        return listener.get();
    }
    ...
    @Override
    public com.shuyu.simple.listener.GSYMediaPlayerListener lastListener() {
    ...
    @Override
    public void setListener(com.shuyu.simple.listener.GSYMediaPlayerListener listener) {
        if (listener == null)
            this.listener = null;
        else
