...
public class TvVideoView extends LinearLayout implements View.OnClickListener {
    ...
    public TvVideoView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    public void setVideoURI(Uri videoUrl, String title) {
        mVideoView.initPlayer(mActivity, videoUrl, title);
    }
